...
from devdraft import Devdraft, AsyncDevdraft, DefaultAioHttpClient
from devdraft._utils import is_dict
...
logging.getLogger("devdraft").setLevel(logging.DEBUG)
...
def client(request: FixtureRequest) -> Iterator[Devdraft]:
...
@pytest.fixture(scope="session")
async def async_client(request: FixtureRequest) -> AsyncIterator[AsyncDevdraft]:
